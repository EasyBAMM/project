                                    ...
                                    <div className="left-button-inside">
                                        <div className="left-img">
                                            <div className="left-back">
                                                <img className="left-back-img" src={fingerprint} alt="fingerprint"></img>
                                            </div>
                                        </div>
                                        ...
                                        <div className="left-toggle-button">
                                            <div className={this.state.Menu1 ? "toggle-btn active" : "toggle-btn"} onClick={this.changeStatus1}>
                            ...
                            <div className="left-menu-padding">
                                <button className="left-button">
                                    <div className="left-button-inside">
                                        <div className="left-img">
                                            <div className="left-back">
                                                <img className="left-back-img" src={driver} alt="fingerprint"></img>
                                            </div>
                                        </div>
                                        <div className="left-text">
                                        ...
                                        <div className="left-toggle-button">
                                            <div className={this.state.Menu2 ? "toggle-btn active" : "toggle-btn"} onClick={this.changeStatus2}>
                                                <div className="inner-circle"></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="left-menu-padding">
                                <button className="left-button">
                                    <div className="left-button-inside">
                                        <div className="left-img">
                                            <div className="left-back">
                                                <img className="left-back-img" src={seatbelt} alt="fingerprint"></img>
                                            </div>
                                        </div>
                                        <div className="left-text">
                                        ...
                                        <div className="left-toggle-button">
                                            <div className={this.state.Menu3 ? "toggle-btn active" : "toggle-btn"} onClick={this.changeStatus3}>
                                                <div className="inner-circle"></div>
                                            </div>
                                        </div>
                                    </div>
